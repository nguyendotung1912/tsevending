...
## ✅ [CẦN SỐ THẬT] — ĐÃ ĐIỀN (2026-06-25)
- **Mục 9 (Về TSE):** dùng số liệu TSE đã công bố tại `/du-an` — 10+ năm kinh nghiệm, 500+ thiết bị vận hành, 50+ đối tác, 4 tỉnh/thành có kỹ thuật viên (TP.HCM, Hà Nội, Đà Nẵng, Bình Dương) + 8 dự án tiêu biểu. Link kiểm chứng sang /du-an.
